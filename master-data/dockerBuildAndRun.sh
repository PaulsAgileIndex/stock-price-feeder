...
## Stage: dev
curl -X PUT -d 'DEV:master-data-app' http://localhost:8500/v1/kv/dev/base/info/deployed/application
curl -X PUT -d 'dev' http://localhost:8500/v1/kv/dev/base/info/deployed/stage

## Stage: test
curl -X PUT -d 'TEST:master-data-app' http://localhost:8500/v1/kv/test/base/info/deployed/application
curl -X PUT -d 'test' http://localhost:8500/v1/kv/test/base/info/deployed/stage

## Stage: uat
curl -X PUT -d 'UAT:master-data-app' http://localhost:8500/v1/kv/uat/base/info/deployed/application
curl -X PUT -d 'uat' http://localhost:8500/v1/kv/uat/base/info/deployed/stage

## Stage: prod
curl -X PUT -d 'master-data-app' http://localhost:8500/v1/kv/prod/base/info/deployed/application
...
docker exec -it master-data-app-prod bash
